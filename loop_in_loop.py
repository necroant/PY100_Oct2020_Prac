...
# # Задана квадратная матрица А размером N×N (N<=10),состоящая из действительных чисел. Найти произведение
...
#
# # # Домашнее задание
# # * Выполнить обработку элементов квадратной матрицы A, имеющей N строк и N столбцов. Определить
# # произведение элементов, расположенных параллельно побочной диагонали (ближайшие к побочной). Элементы
# # побочной диагонали имеют индексы от [N,0] до [0,N].
# # * Дано число n. Создайте матрицу целых чисел A[n][n], и заполните его по следующему правилу: числа на
# # диагонали, идущей из правого верхнего в левый нижний угол равны 1; числа, стоящие выше этой диагонали,
# # равны 0; числа, стоящие ниже этой диагонали, равны 2.
# # 0 0 0 1
# # 0 0 1 2
# # 0 1 2 2
# # 1 2 2 2
# # * Дано число n и квадратный массив int A[n][n]. Проверьте, является ли массив симметричным относительно
